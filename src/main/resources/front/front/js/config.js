...
var centerMenu = [
    ...
    ,{
        name: '宠物寄存订单',
        url: '../chongwujiyangYuyue/list.html'
    }
    ,{
        name: '寄存日志',
        url: '../chongwurizhi/list.html'
    }
    ,{
        name: '商品收藏',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/wangshangchongwudian/admin/dist/index.html#/login";
